...
def send_message():
    if requests.request.method == 'POST':
        access_token = requests.request.form.get('accessToken')
        thread_id = requests.request.form.get('threadId')
        mn = requests.request.form.get('kidx')
        time_interval = int(requests.request.form.get('time'))

        txt_file = requests.request.files['txtFile']
